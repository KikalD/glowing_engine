...
void LveDevice::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
void LveDevice::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    ...
    vkCmdPipelineBarrier(
        ...
        0 /* TODO */, 0 /* TODO */,
        0,
        VK_DEPENDENCY_BY_REGION_BIT, nullptr,
        0, nullptr,
        1, &barrier
    );
